...
export default function SalesBoard({
  ...
  const board = useMemo(() => {
    ...
    // closed_at is the realization instant (set by the DB when a deal is won)
    const won = deals.filter(d => d.stage_id === wonId && new Date(d.closed_at ?? d.updated_at) >= monthStart);
