  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1"><h1 className="text-2xl font-bold text-slate-900">{deal.title}</h1>{contact && <Link to={`/contacts/${deal.contact_id}`} className="text-sm text-sky-500 hover:text-sky-600 mt-1 inline-block">{contact.first_name} {contact.last_name} Â· {contact.phone}</Link>}</div>
