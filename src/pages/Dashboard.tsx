...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-5 max-w-7xl mx-auto">
      ...
      <section className="overflow-hidden rounded-2xl border border-ink-700 bg-[radial-gradient(circle_at_top_left,_rgba(16,117,184,0.22),_transparent_45%),linear-gradient(135deg,_rgba(15,23,42,0.96),_rgba(15,23,42,0.86))] p-5 sm:p-6">
