...
export default function UpdateNotice() {
  ...
  return <aside role="status" className="shrink-0 flex flex-wrap items-center justify-between gap-2 border-b border-brand-500/30 bg-ink-900 px-4 py-3 text-sm text-ink-100">
    <span>{offline ? 'You are offline. Saved views may be out of date. Reconnect before saving changes.' : 'An update is ready. You can keep working and update after saving your edits.'}</span>
