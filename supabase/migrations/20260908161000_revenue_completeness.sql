-- Add completeness alongside existing amounts; older clients retain their contract.
...
as $$
  ...
  select jsonb_build_object(
    ...
    'missing_amount_count', (select count(*) from filtered_deals where amount is null),
    'closed_deal_count', (select count(*) from filtered_deals),
