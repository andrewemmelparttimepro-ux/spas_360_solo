...
const items: InventoryFlooringReportItem[] = [
  { id: '1', location_id: 'a', sku: '100 "Wells Fargo"', product: 'Spa', brand: 'A', model: 'One', status: 'In Stock', cost: 10000 },
  { id: '2', location_id: 'b', sku: '200 "MCHL TCCU"', product: 'Spa', brand: 'B', model: 'Two', status: 'On Order', cost: 20000 },
  { id: '3', location_id: 'b', sku: '300 wells fargo', product: 'Spa', brand: 'C', model: 'Three', status: 'Sold', cost: null },
  { id: '4', location_id: 'a', sku: '400', product: 'Spa', brand: 'D', model: 'Four', status: 'Delivered', cost: 5000 },
];
...
describe('Inventory Flooring Status report', () => {
  it('builds actual designation options and filters without dropping unassigned inventory by default', () => {
    assert.deepEqual(inventoryFlooringOptions(items), ['MCHL TCCU', 'Wells Fargo']);
