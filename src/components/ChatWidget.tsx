    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          isOpen
            ...
            : "bg-brand-500 text-white shadow-brand-500/30 hover:shadow-brand-500/50"
        )}
      >
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[400px] h-[560px] bg-ink-900 rounded-2xl shadow-2xl border border-ink-700 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="bg-ink-900 text-white px-4 py-3 flex items-center justify-between shrink-0">
            {!isAgent && teamView === 'chat' ? (
              <>
                <div className="flex items-center">
                  <button onClick={() => setTeamView('directory')} className="p-1 mr-2 hover:bg-ink-800 rounded">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-ink-500">{chatHeaderSub()}</p>
                  </div>
                </div>
              </>
            ) : (
          ...
          {/* Tab Switcher */}
          <div className="flex border-b border-ink-700 shrink-0 bg-ink-950">
            <button
              ...
              className={cn("flex-1 py-2 text-xs font-semibold transition-colors flex items-center justify-center",
                tab === 'agent' ? "text-brand-400 border-b-2 border-brand-500 bg-ink-900" : "text-ink-400 hover:text-ink-300"
              )}
            >
            ...
            <button
              ...
              className={cn("flex-1 py-2 text-xs font-semibold transition-colors flex items-center justify-center",
                tab === 'team' ? "text-brand-400 border-b-2 border-brand-500 bg-ink-900" : "text-ink-400 hover:text-ink-300"
              )}
            >
